		...
		<div class="headpreims-wrap">
			...
			<div class="headpreims">
				...
				<div class="headpreim">
					...
					<div class="headpreim__descr">Собственный проектный отдел, который позволяет осуществить проект любой сложности в кратчайшие сроки.</div>
				</div>
				<div class="headpreim">
					<div class="headpreim__icon">
						<img src="/img/lp/kotel/headpreim-ic-3.svg" alt="img">
					</div>
					<div class="headpreim__title">Полное сопровождение</div>
					<div class="headpreim__descr">Мы осуществляем полный цикл работ начиная от получения технических условий, заканчивая сдачей котельной в эксплуатацию.</div>
				</div>
				<div class="headpreim">
					<div class="headpreim__icon">
					...
					<div class="headpreim__descr">Собственная сервисная служба, которая осуществляет сервис, эксплуатацию и техническую поддержку котельных в режиме 24/7</div>
				</div>
			</div>
		</div>
		...
		<form class="calc ajax-form">
			...
			<div class="calc__right">
				...
				<div class="calc__step">
					...
					<div class="calc__radios">
						<label class="style-radio-btn">
							<input type="radio" value="station" name="variant" title="Вариант исполнения" data-label="Вариант исполнения" checked>
							<span>Стационарное</span>
						</label>
						<label class="style-radio-btn">
							<input type="radio" value="block" name="variant" title="Вариант исполнения" data-label="Вариант исполнения">
			...
			<div class="basecomp__top">
				<div class="basecomp__items">
					...
					<div class="basecomp__item">
						...
						<span>ХВО – Na<br>катионитный фильтр</span>
					</div>
					<div class="basecomp__item">
			...
			<div class="basecomp__bottom">
				<div class="basecomp__items">
					...
					<div class="basecomp__item">
						...
						<span>Блок химводополготовик</span>
					</div>
					<div class="basecomp__item">
	...
	<div class="container">
		...
		<div class="lp-preims">
			<div class="headpreim">
				...
				<div class="headpreim__descr">Монтаж котельной возможен практически на любую открытую площадку и не требует капитального строительства или фундамента</div>
			</div>
			<div class="headpreim">
				<div class="headpreim__icon">
